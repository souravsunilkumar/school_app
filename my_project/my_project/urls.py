...
urlpatterns = [
    ...
    path('employee-registration-sub-admin/', views.Employee_Reg_Sub_Admin, name='employee_registration_sub_admin'),
    path('sub-admin-register/', views.Sub_Admin_Reg, name='sub_admin_register'),
